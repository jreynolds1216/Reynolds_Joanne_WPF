...
//Added an alert so the user doesn't have to check the console to get the same message.
    alert("You need to cut the grass today! Your yard looks like a jungle.");
...
//Added an alert so the user doesn't have to check the console to get the same message if it is raining outside.
    alert("You can't cut your grass today. It is raining outside.");
