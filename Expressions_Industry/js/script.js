...
var numberOfTechs = prompt("We are calculating the number of jobs the technicians need to do per hour to get all jobs done in the alloted number of hours. Please enter the number of technicians working:");
